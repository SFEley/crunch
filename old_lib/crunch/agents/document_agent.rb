...
module Crunch
  class DocumentAgent < Agent
    ...
    # still no concept of an owner here. Whatever creates this agent (probably a 
    ...
    def initialize(collection, query, options={})
      ...
      # This callback relies on the one from Agent breaking the binary data into
    ...
    # single method call.
    # Does the following:
    #   1. Creates a new DocumentAgent object, extracting the collection, query and
    ...
    # @yield [fieldset] Becomes a callback in the agent. Use this to capture the document
