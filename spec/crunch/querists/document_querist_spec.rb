...
module Crunch
  describe DocumentQuerist do
    ...
    describe ".run method" do
      before(:each) do
        @document = stub "Document", collection: @collection, query: @query, options: {}
      ...
      it "takes a Document object and uses it for base parameters" do
        ->{DocumentQuerist.run @document}.should_not raise_error
      end
      
      it "returns a DocumentQuerist object" do
        DocumentQuerist.run(@document).should be_a(Querist)
      end
    end
