  ...
  describe "utility methods" do
    ...
    describe "- int_to_bson" do
      ...
      it "returns short numbers as some ridiculous length if specified" do
        Crunch.int_to_bson(100, length: 16).should == "\x64\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
      end
      ...
      it "throws an error if underflowing on negative integers" do
        ->{Crunch.int_to_bson(-2147483649, length: 4)}.should raise_error(Crunch::CrunchError, /overflow/)
      end
    end
